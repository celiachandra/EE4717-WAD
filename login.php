...
if ($userType=='Doctor') {
    ...
    $sql="SELECT Name FROM patients WHERE Email= '$email' AND Password= '$password'; ";
        ...
        <div class='boxes'>
            ...
            <form method="post" action="">
                <table class='details'>
                    ...
                    <tr>
                        <td colspan="2"><label for="userType">User Type:</label><select id="userType" name="userType">
                                <option value="Patient">Patient</option>
                                <option value="Doctor">Doctor</option>
                            </select></td>
                    </tr>
                </table><input type="submit" value="LOGIN" name='submit' id='Register'>
            </form>
        </div>
</body>
</div>
<footer><small><i>Copyright &copy;
            ...
            Toronto,
            Ontario</i></small><br><small><i><a href="mailto:prime@clinic.com">prime@clinic.com</a></i></small></footer>
